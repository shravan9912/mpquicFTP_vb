...
import (
	...
	mpqConstants "github.com/shravan9912/mpquic_ml_vb/constants"

	"github.com/shravan9912/mpquicFTP_vb/common"
	"github.com/shravan9912/mpquicFTP_vb/constants"
)
...
func initializeClientArguments() (string, string, string, string, string, *quic.Config) {
	...
	isTraining := flag.Bool(constants.SCHEDULER_TRAINING, false, "a bool(true, false), default: false")
