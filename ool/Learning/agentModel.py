...
def generate_agent(filename, steps=1000):
    ...
    dqn = OfflineDQNAgent(model=model, nb_actions=2, memory=memory, nb_steps_warmup=200, target_model_update=1e-4, policy=policy, enable_double_dqn=False)
