...
const ReceiveStreamFlowControlWindow = (1 << 20) * 8 // 32 kB

// ReceiveConnectionFlowControlWindow is the connection-level flow control window for receiving data
// This is the value that Google servers are using
const ReceiveConnectionFlowControlWindow = (1 << 20) * 12 // 48 kB
...
// This is the value that Google servers are using
const DefaultMaxReceiveStreamFlowControlWindowServer = 16 * (1 << 20) // 1 MB
...
// This is the value that Google servers are using
const DefaultMaxReceiveConnectionFlowControlWindowServer = 24 * (1 << 20) // 1.5 MB
